...
export const CAPTION_STYLE_PRESETS: ReadonlyArray<CaptionStylePreset> = [
  {
    id: "basic_white",
    name: "Classic White",
    desc: "Clean white captions with a dark outline",
    color: "#ffffff",
  ...
  },
  {
    id: "hormozi_green",
    name: "Bold Green",
    desc: "Strong green highlight for emphasis",
    color: "#00FF00",
  ...
  },
  {
    ...
    desc: "Bright yellow highlight for short-form video",
    color: "#FFD600",
  ...
  },
  {
    id: "orange_fire",
    name: "Orange Fire",
    desc: "Warm orange fire highlight with bold weight",
    color: "#FF6A00",
    preview_words: ["Feel", "THE", "heat"],
    preview_class: "fire",
    config: {
      font_name: "Arial-Black",
      font_size: 28,
  ...
  },
  {
    id: "pop_cyan",
    name: "Bright Cyan",
    desc: "Cyan pop highlight for energetic cuts",
    color: "#00FFFF",
  ...
  },
  {
    id: "minimalist",
    name: "Soft Minimal",
    desc: "Light pastel captions with a soft look",
    color: "#F48FB1",
  ...
  },
  {
    id: "desi_gold",
    name: "Warm Gold",
    desc: "Gold accents suited to Indic content",
    color: "#FFD700",
    preview_words: ["Namaste", "GOLD", "tone"],
    preview_class: "desi",
    config: {
  ...
  },
  {
    id: "indic_clean",
    name: "Native Script",
    desc: "Clear Indic-script captions with native fonts",
    color: "#80DEEA",
